...
let creditsBtn = document.querySelector("#creditsBtn") as HTMLElement;

let leadersBtn = document.querySelector('#leader-btn') as HTMLElement;

let closeCrBtn = document.querySelector('#close-modal-cr') as HTMLElement;

let closeLdBtn = document.querySelector('#close-modal-ld') as HTMLElement;

let playGameBtn = document.querySelector('#play-game-btn') as HTMLElement;
...
let creditsModal= document.querySelector('#modal-credits') as HTMLElement;

let leaderBoardModal = document.querySelector('#modal-leader-board') as HTMLElement;
...
async function displayData(){
    ...
    let tbody = document.querySelector('#tbody') as HTMLElement; //getting the table body to append the scores.
